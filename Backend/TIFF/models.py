...
class Image(models.Model):
    ...
    progress = models.CharField(max_length=16, verbose_name=u"当前算法处理进度")
    result_auto = models.CharField(max_length=32, verbose_name=u"算法诊断结果")
    result_manual = models.CharField(max_length=32, verbose_name=u"医生诊断结果")
    result_status = models.CharField(max_length=32, verbose_name=u"标准诊断结果")
