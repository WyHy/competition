...
class Image(models.Model):
    ...
    progress = models.CharField(max_length=16, verbose_name=u"当前算法处理进度", null=True, blank=True)
    result_auto = models.CharField(max_length=64, verbose_name=u"算法诊断结果", null=True, blank=True)
